...
/*:
Set the variable called `starterMessage` to greet the user and ask them how they are feeling
 - Example:
 ```
...
/*:
Set the variable called `responseMessage` to empathize with the user before presenting them with needed resources.
 - Example:
 ```
